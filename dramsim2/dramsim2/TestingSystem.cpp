...
void TestingSystem::Initialize()
{
    ...
    memory = new MemorySystem(0, deviceIniFilename, systemIniFilename, "", "SimulationResults.txt", megsOfMemory);
...
void TestingSystem::start()
{
    ...
    /*for (int i = 0; i < 5; i++)
    {
        transactions.push_back(Trans(true, AlignAddress(i), i * 5));
    }
    for (int i = 4; i >= 0; i--)
    {
        transactions.push_back(Trans(false, AlignAddress(i), i * 5));
    }*/
