...
void TestingSystem::Initialize()
{
    ...
    memory = new MemorySystem(0, deviceIniFilename, systemIniFilename, "", "SimulationResults.txt", megsOfMemory, 0, "MATS++", "faults//CFin//CFin2.csv");
...
void TestingSystem::start()
{
	...
	//transactions.push_back(Trans(true, 12458, 65535));
	//transactions.push_back(Trans(true, 12458, 65535));
	//transactions.push_back(Trans(true, 12458, 65535));
	//transactions.push_back(Trans(true, 12458, 65535));
